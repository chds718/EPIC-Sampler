...
public class EPICResultsFilter extends javax.swing.filechooser.FileFilter {
    public boolean accept(File f) {
        return f.isDirectory() || f.getName().toLowerCase().endsWith(".epicres");
    }
    
    public String getDescription() {
        return "EPIC Search Results";
    }
}